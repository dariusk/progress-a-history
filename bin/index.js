...
.option('-b, --basic', 'adds AI to brute-force different choices', false)
.option('-i, --interactive', 'adds an AI the player controls directly', false)
...
var human = program.interactive && progress.players.common.repl;
